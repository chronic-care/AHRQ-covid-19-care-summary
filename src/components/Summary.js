      ...
      <div className="summary">
        ...
        <div className="summary__display" id="maincontent">
          <div className="summary__display-title">
            Factors to Consider in Managing COVID-19
          </div>
          ...
          <main className="sections">
            ...
            <Collapsible tabIndex={0} trigger={this.renderSectionHeader("DiagnosticTests")} open={true}>
              {this.renderSection("DiagnosticTests")}
            </Collapsible>
          ...
          <div className="cdc-disclaimer">
            ...
            <a
              ...
              alt="CDC Guidelines for Coronavirus (COVID-19)"
              target="_blank"
